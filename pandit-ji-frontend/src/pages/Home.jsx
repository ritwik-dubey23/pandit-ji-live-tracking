    ...
    return (
        <div className="w-full min-h-screen flex flex-col justify-between bg-[#fff9f6]">
            <div>
                ...
                {searchQuery.trim() ? (
                    /* FOCUSED SEARCH RESULTS VIEW (Zomato/Swiggy Marketplace Style) */
                    <div className="w-full max-w-6xl mx-auto px-4 pt-[95px] pb-12 space-y-6">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-orange-200 pb-4">
                            <div>
                                ...
                                <h2 className="text-2xl sm:text-3xl font-black text-gray-900 mt-2">
                                    Search Results for "{searchQuery}" ({panditsList.length})
                                </h2>
                            </div>
                            <button
                                type="button"
                        ...
                        {panditsList.length === 0 ? (
                            <div className="bg-white rounded-3xl p-10 sm:p-14 text-center border border-orange-100 shadow-sm max-w-lg mx-auto my-8 space-y-3">
                                ...
                                <h3 className="text-lg sm:text-xl font-black text-gray-900">No Matching Results Found</h3>
                                <p className="text-xs sm:text-sm text-gray-500 font-medium leading-relaxed">
                                    No Pandit Ji or service matched <strong className="text-gray-900">"{searchQuery}"</strong>. Try searching for <span className="text-[#ff4d2d] font-bold">Havan, Griha Pravesh, Satyanarayan</span>, or city names like <span className="text-[#ff4d2d] font-bold">Indore</span>.
                                </p>
                                <button
                                    type="button"
                                    onClick={() => setSearchQuery("")}
                            ...
                            <div className="w-full flex flex-wrap gap-6 justify-start max-sm:grid max-sm:grid-cols-1 pt-2">
